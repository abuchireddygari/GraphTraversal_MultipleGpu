...
//				sub_counter;
	...
	{
		enum {
			MEM_BANKS 					= 1 << B40C_LOG_MEM_BANKS_BFS(__B40C_CUDA_ARCH__),
			DIGITS_PER_SCATTER_PASS 	= KernelPolicy::WARPS * (B40C_WARP_THREADS_BFS(__B40C_CUDA_ARCH__) / (MEM_BANKS)),
		...
		struct WarpScatter
		{
			...
			{
				const int LOG_STORE_TXN_THREADS = B40C_LOG_MEM_BANKS_BFS(__B40C_CUDA_ARCH__);
