...
#include <b40c/copy_if/upsweep/kernel_policy.cuh>
#include <b40c/copy_if/downsweep/kernel.cuh>
#include <b40c/copy_if/downsweep/kernel_policy.cuh>
#include <b40c/copy_if/spine/kernel.cuh>
...
struct Policy : ProblemType
{
	...
	// Kernel config for the spine Copy-if kernel
