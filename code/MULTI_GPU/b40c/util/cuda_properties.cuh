...
// Threads per warp. 
#define B40C_LOG_WARP_THREADS_BFS(arch)		(5)			// 32 threads in a warp 
#define B40C_WARP_THREADS_BFS(arch)			(1 << B40C_LOG_WARP_THREADS_BFS(arch))
...
#define B40C_LOG_MEM_BANKS_BFS(arch)		((arch >= 200) ? B40C_SM20_LOG_MEM_BANKS() : 	\
