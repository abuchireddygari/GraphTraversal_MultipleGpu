...
struct RakingGrid
{
	...
	enum {
		...
		LOG_PARTIALS_PER_BANK_ARRAY		= B40C_LOG_MEM_BANKS_BFS(CUDA_ARCH) +
		...
		NO_PADDING = (LOG_SEGS_PER_BANK_ARRAY >= B40C_LOG_WARP_THREADS_BFS(CUDA_ARCH)),
	...
	typedef typename If<_DEPENDENT_LANES && (LOG_RAKING_THREADS > B40C_LOG_WARP_THREADS_BFS(CUDA_ARCH)),
		RakingGrid<										// Yes secondary grid
			...
			B40C_LOG_WARP_THREADS_BFS(CUDA_ARCH),					// Raking threads (1 warp)
